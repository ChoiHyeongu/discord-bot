...
class Action:
    ...
    # 프로젝트 마감일
    def remain_deadline(self):
        today = datetime.datetime.now
        remain = Config.DEADLINE - today
        return "{$0}일 남음".format(remain.days)